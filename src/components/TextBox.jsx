...
function handleNext() {
    if (nextIndex < tasks.length - 1) {
        ...
        setNextIndex(currentIndex + 2); // Update nextIndex to currentIndex + 2
    } else {
        // Handle the case when the last element is reached
...
function HandleNo() {
    ...
    return (
        <div className='flex flex-col gap-4 items-center bg-white/50 p-4 rounded-md'>
